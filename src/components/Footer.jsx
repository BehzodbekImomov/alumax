      ...
      <div className="container px-5 mx-auto ">
        <div className="footer_section1 flex justify-between flex-wrap">
          <div className="footer_desc">
            ...
            <p>
              Обеспечение стабильного качества продукции и возможность
              максимально быстро реагировать на запросы и потребности заказчиков
              является следствием политики AS ALFA STROY проводимой в отношении
              производства. Такой подход к производству композитных панелей из
              алюминия и компаунда выгодно отличает всю нашу продукцию от
              продукции конкурентов-производителей и импортеров.
            </p>
